...
// This should almost always be used instead of []*FSMosquitoinspection.
...
// fsMosquitoinspectionR is where relationships are stored.
type fsMosquitoinspectionR struct {
	Organization *Organization // fs_mosquitoinspection.fs_mosquitoinspection_organization_id_fkey
}
...
func (fsMosquitoinspectionColumns) AliasedAs(alias string) fsMosquitoinspectionColumns {
	return buildFSMosquitoinspectionColumns(alias)
}

// FSMosquitoinspectionSetter is used for insert/upsert/update operations
...
func (s *FSMosquitoinspectionSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
		...
		if s.Updated.IsValue() {
			vals[60] = psql.Arg(s.Updated.MustGet())
		} else {
...
func (s FSMosquitoinspectionSetter) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
...
// FindFSMosquitoinspection retrieves a single record by primary key
...
func FindFSMosquitoinspection(ctx context.Context, exec bob.Executor, ObjectidPK int32, cols ...string) (*FSMosquitoinspection, error) {
	if len(cols) == 0 {
		return FSMosquitoinspections.Query(
			sm.Where(FSMosquitoinspections.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
		).One(ctx, exec)
	}

	return FSMosquitoinspections.Query(
		sm.Where(FSMosquitoinspections.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
		sm.Columns(FSMosquitoinspections.Columns.Only(cols...)),
	).One(ctx, exec)
}
...
func (o *FSMosquitoinspection) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	case bob.QueryTypeSelect:
		ctx, err = FSMosquitoinspections.AfterSelectHooks.RunHooks(ctx, exec, FSMosquitoinspectionSlice{o})
	case bob.QueryTypeInsert:
		ctx, err = FSMosquitoinspections.AfterInsertHooks.RunHooks(ctx, exec, FSMosquitoinspectionSlice{o})
	case bob.QueryTypeUpdate:
		ctx, err = FSMosquitoinspections.AfterUpdateHooks.RunHooks(ctx, exec, FSMosquitoinspectionSlice{o})
	case bob.QueryTypeDelete:
		ctx, err = FSMosquitoinspections.AfterDeleteHooks.RunHooks(ctx, exec, FSMosquitoinspectionSlice{o})
	}

	return err
}

// primaryKeyVals returns the primary key values of the FSMosquitoinspection
func (o *FSMosquitoinspection) primaryKeyVals() bob.Expression {
...
func (o *FSMosquitoinspection) Update(ctx context.Context, exec bob.Executor, s *FSMosquitoinspectionSetter) error {
	v, err := FSMosquitoinspections.Update(s.UpdateMod(), um.Where(o.pkEQ())).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *FSMosquitoinspection) Delete(ctx context.Context, exec bob.Executor) error {
	_, err := FSMosquitoinspections.Delete(dm.Where(o.pkEQ())).Exec(ctx, exec)
	return err
}
...
func (o *FSMosquitoinspection) Reload(ctx context.Context, exec bob.Executor) error {
	o2, err := FSMosquitoinspections.Query(
		sm.Where(FSMosquitoinspections.Columns.Objectid.EQ(psql.Arg(o.Objectid))),
	).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o FSMosquitoinspectionSlice) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	switch queryType {
	case bob.QueryTypeSelect:
		ctx, err = FSMosquitoinspections.AfterSelectHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeInsert:
		ctx, err = FSMosquitoinspections.AfterInsertHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeUpdate:
		ctx, err = FSMosquitoinspections.AfterUpdateHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeDelete:
		ctx, err = FSMosquitoinspections.AfterDeleteHooks.RunHooks(ctx, exec, o)
	}

	return err
}

func (o FSMosquitoinspectionSlice) pkIN() dialect.Expression {
	if len(o) == 0 {
...
func (o FSMosquitoinspectionSlice) copyMatchingRows(from ...*FSMosquitoinspection) {
	for i, old := range o {
...
func (o FSMosquitoinspectionSlice) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
	return bob.ModFunc[*dialect.UpdateQuery](func(q *dialect.UpdateQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return FSMosquitoinspections.BeforeUpdateHooks.RunHooks(ctx, exec, o)
		})

		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			var err error
			switch retrieved := retrieved.(type) {
			case *FSMosquitoinspection:
				o.copyMatchingRows(retrieved)
			case []*FSMosquitoinspection:
				o.copyMatchingRows(retrieved...)
			case FSMosquitoinspectionSlice:
				o.copyMatchingRows(retrieved...)
			default:
				// If the retrieved value is not a FSMosquitoinspection or a slice of FSMosquitoinspection
				// then run the AfterUpdateHooks on the slice
				_, err = FSMosquitoinspections.AfterUpdateHooks.RunHooks(ctx, exec, o)
			}
...
func (o FSMosquitoinspectionSlice) DeleteMod() bob.Mod[*dialect.DeleteQuery] {
	return bob.ModFunc[*dialect.DeleteQuery](func(q *dialect.DeleteQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return FSMosquitoinspections.BeforeDeleteHooks.RunHooks(ctx, exec, o)
		})
		...
		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			...
			default:
				...
				_, err = FSMosquitoinspections.AfterDeleteHooks.RunHooks(ctx, exec, o)
			}
...
func (o FSMosquitoinspectionSlice) UpdateAll(ctx context.Context, exec bob.Executor, vals FSMosquitoinspectionSetter) error {
	if len(o) == 0 {
		return nil
	}

	_, err := FSMosquitoinspections.Update(vals.UpdateMod(), o.UpdateMod()).All(ctx, exec)
	return err
}
...
func (o FSMosquitoinspectionSlice) DeleteAll(ctx context.Context, exec bob.Executor) error {
	...
	_, err := FSMosquitoinspections.Delete(o.DeleteMod()).Exec(ctx, exec)
	return err
}
...
func (o FSMosquitoinspectionSlice) ReloadAll(ctx context.Context, exec bob.Executor) error {
	...
	o2, err := FSMosquitoinspections.Query(sm.Where(o.pkIN())).All(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *FSMosquitoinspection) Organization(mods ...bob.Mod[*dialect.SelectQuery]) OrganizationsQuery {
...
func attachFSMosquitoinspectionOrganization0(ctx context.Context, exec bob.Executor, count int, fsMosquitoinspection0 *FSMosquitoinspection, organization1 *Organization) (*FSMosquitoinspection, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("attachFSMosquitoinspectionOrganization0: %w", err)
	}

	return fsMosquitoinspection0, nil
}
...
func (fsMosquitoinspection0 *FSMosquitoinspection) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachFSMosquitoinspectionOrganization0(ctx, exec, 1, fsMosquitoinspection0, organization1)
	if err != nil {
		return err
	}

	fsMosquitoinspection0.R.Organization = organization1

	organization1.R.FSMosquitoinspections = append(organization1.R.FSMosquitoinspections, fsMosquitoinspection0)
...
func (fsMosquitoinspectionWhere[Q]) AliasedAs(alias string) fsMosquitoinspectionWhere[Q] {
	return buildFSMosquitoinspectionWhere[Q](buildFSMosquitoinspectionColumns(alias))
}
...
func (o *FSMosquitoinspection) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("fsMosquitoinspection cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.FSMosquitoinspections = FSMosquitoinspectionSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("fsMosquitoinspection has no relationship %q", name)
	}
}

type fsMosquitoinspectionPreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildFSMosquitoinspectionPreloader() fsMosquitoinspectionPreloader {
	return fsMosquitoinspectionPreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        FSMosquitoinspections,
						To:          Organizations,
...
type fsMosquitoinspectionThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildFSMosquitoinspectionThenLoader[Q orm.Loadable]() fsMosquitoinspectionThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return fsMosquitoinspectionThenLoader[Q]{
...
func (o *FSMosquitoinspection) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.FSMosquitoinspections = FSMosquitoinspectionSlice{o}
...
type fsMosquitoinspectionJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j fsMosquitoinspectionJoins[Q]) aliasedAs(alias string) fsMosquitoinspectionJoins[Q] {
	return buildFSMosquitoinspectionJoins[Q](buildFSMosquitoinspectionColumns(alias), j.typ)
}

func buildFSMosquitoinspectionJoins[Q dialect.Joinable](cols fsMosquitoinspectionColumns, typ string) fsMosquitoinspectionJoins[Q] {
	return fsMosquitoinspectionJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

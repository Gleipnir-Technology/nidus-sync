...
func (o *SpatialRefSy) pkEQ() dialect.Expression {
	return psql.Quote("spatial_ref_sys", "srid").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
...
func (o SpatialRefSySlice) pkIN() dialect.Expression {
	...
	return psql.Quote("spatial_ref_sys", "srid").In(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {

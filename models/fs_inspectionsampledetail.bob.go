...
// FSInspectionsampledetailSlice is an alias for a slice of pointers to FSInspectionsampledetail.
// This should almost always be used instead of []*FSInspectionsampledetail.
...
// fsInspectionsampledetailR is where relationships are stored.
type fsInspectionsampledetailR struct {
	Organization *Organization // fs_inspectionsampledetail.fs_inspectionsampledetail_organization_id_fkey
}

func buildFSInspectionsampledetailColumns(alias string) fsInspectionsampledetailColumns {
	return fsInspectionsampledetailColumns{
		ColumnsExpr: expr.NewColumnsExpr(
			"organization_id", "comments", "creationdate", "creator", "editdate", "editor", "fadultact", "fdomstage", "feggcount", "fieldspecies", "flarvcount", "flstages", "fpupcount", "globalid", "inspsample_id", "labspecies", "ldomstage", "leggcount", "llarvcount", "lpupcount", "objectid", "processed", "created_date", "created_user", "geometry_x", "geometry_y", "last_edited_date", "last_edited_user", "updated",
		).WithParent("fs_inspectionsampledetail"),
		tableAlias:     alias,
...
func (c fsInspectionsampledetailColumns) Alias() string {
	return c.tableAlias
}

func (fsInspectionsampledetailColumns) AliasedAs(alias string) fsInspectionsampledetailColumns {
	return buildFSInspectionsampledetailColumns(alias)
}
...
func (s *FSInspectionsampledetailSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
		...
		if s.Updated.IsValue() {
			vals[28] = psql.Arg(s.Updated.MustGet())
		} else {
...
func (s FSInspectionsampledetailSetter) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
...
// FindFSInspectionsampledetail retrieves a single record by primary key
...
func FindFSInspectionsampledetail(ctx context.Context, exec bob.Executor, ObjectidPK int32, cols ...string) (*FSInspectionsampledetail, error) {
	if len(cols) == 0 {
		return FSInspectionsampledetails.Query(
			sm.Where(FSInspectionsampledetails.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
		).One(ctx, exec)
	}

	return FSInspectionsampledetails.Query(
		sm.Where(FSInspectionsampledetails.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
		sm.Columns(FSInspectionsampledetails.Columns.Only(cols...)),
	).One(ctx, exec)
}
...
func (o *FSInspectionsampledetail) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	case bob.QueryTypeSelect:
		ctx, err = FSInspectionsampledetails.AfterSelectHooks.RunHooks(ctx, exec, FSInspectionsampledetailSlice{o})
	case bob.QueryTypeInsert:
		ctx, err = FSInspectionsampledetails.AfterInsertHooks.RunHooks(ctx, exec, FSInspectionsampledetailSlice{o})
	case bob.QueryTypeUpdate:
		ctx, err = FSInspectionsampledetails.AfterUpdateHooks.RunHooks(ctx, exec, FSInspectionsampledetailSlice{o})
	case bob.QueryTypeDelete:
		ctx, err = FSInspectionsampledetails.AfterDeleteHooks.RunHooks(ctx, exec, FSInspectionsampledetailSlice{o})
	}

	return err
}

// primaryKeyVals returns the primary key values of the FSInspectionsampledetail
func (o *FSInspectionsampledetail) primaryKeyVals() bob.Expression {
...
func (o *FSInspectionsampledetail) Update(ctx context.Context, exec bob.Executor, s *FSInspectionsampledetailSetter) error {
	v, err := FSInspectionsampledetails.Update(s.UpdateMod(), um.Where(o.pkEQ())).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *FSInspectionsampledetail) Delete(ctx context.Context, exec bob.Executor) error {
	_, err := FSInspectionsampledetails.Delete(dm.Where(o.pkEQ())).Exec(ctx, exec)
	return err
}

// Reload refreshes the FSInspectionsampledetail using the executor
func (o *FSInspectionsampledetail) Reload(ctx context.Context, exec bob.Executor) error {
	o2, err := FSInspectionsampledetails.Query(
		sm.Where(FSInspectionsampledetails.Columns.Objectid.EQ(psql.Arg(o.Objectid))),
	).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o FSInspectionsampledetailSlice) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	switch queryType {
	case bob.QueryTypeSelect:
		ctx, err = FSInspectionsampledetails.AfterSelectHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeInsert:
		ctx, err = FSInspectionsampledetails.AfterInsertHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeUpdate:
		ctx, err = FSInspectionsampledetails.AfterUpdateHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeDelete:
		ctx, err = FSInspectionsampledetails.AfterDeleteHooks.RunHooks(ctx, exec, o)
	}

	return err
}

func (o FSInspectionsampledetailSlice) pkIN() dialect.Expression {
	if len(o) == 0 {
...
func (o FSInspectionsampledetailSlice) copyMatchingRows(from ...*FSInspectionsampledetail) {
	for i, old := range o {
...
func (o FSInspectionsampledetailSlice) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
	return bob.ModFunc[*dialect.UpdateQuery](func(q *dialect.UpdateQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return FSInspectionsampledetails.BeforeUpdateHooks.RunHooks(ctx, exec, o)
		})

		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			var err error
			switch retrieved := retrieved.(type) {
			case *FSInspectionsampledetail:
				o.copyMatchingRows(retrieved)
			case []*FSInspectionsampledetail:
				o.copyMatchingRows(retrieved...)
			case FSInspectionsampledetailSlice:
				o.copyMatchingRows(retrieved...)
			default:
				// If the retrieved value is not a FSInspectionsampledetail or a slice of FSInspectionsampledetail
				// then run the AfterUpdateHooks on the slice
				_, err = FSInspectionsampledetails.AfterUpdateHooks.RunHooks(ctx, exec, o)
			}
...
func (o FSInspectionsampledetailSlice) DeleteMod() bob.Mod[*dialect.DeleteQuery] {
	return bob.ModFunc[*dialect.DeleteQuery](func(q *dialect.DeleteQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return FSInspectionsampledetails.BeforeDeleteHooks.RunHooks(ctx, exec, o)
		})
		...
		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			...
			default:
				...
				_, err = FSInspectionsampledetails.AfterDeleteHooks.RunHooks(ctx, exec, o)
			}
...
func (o FSInspectionsampledetailSlice) UpdateAll(ctx context.Context, exec bob.Executor, vals FSInspectionsampledetailSetter) error {
	if len(o) == 0 {
		return nil
	}

	_, err := FSInspectionsampledetails.Update(vals.UpdateMod(), o.UpdateMod()).All(ctx, exec)
	return err
}

func (o FSInspectionsampledetailSlice) DeleteAll(ctx context.Context, exec bob.Executor) error {
	if len(o) == 0 {
		return nil
	}

	_, err := FSInspectionsampledetails.Delete(o.DeleteMod()).Exec(ctx, exec)
	return err
}

func (o FSInspectionsampledetailSlice) ReloadAll(ctx context.Context, exec bob.Executor) error {
	if len(o) == 0 {
		return nil
	}

	o2, err := FSInspectionsampledetails.Query(sm.Where(o.pkIN())).All(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *FSInspectionsampledetail) Organization(mods ...bob.Mod[*dialect.SelectQuery]) OrganizationsQuery {
...
func attachFSInspectionsampledetailOrganization0(ctx context.Context, exec bob.Executor, count int, fsInspectionsampledetail0 *FSInspectionsampledetail, organization1 *Organization) (*FSInspectionsampledetail, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("attachFSInspectionsampledetailOrganization0: %w", err)
	}

	return fsInspectionsampledetail0, nil
}
...
func (fsInspectionsampledetail0 *FSInspectionsampledetail) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachFSInspectionsampledetailOrganization0(ctx, exec, 1, fsInspectionsampledetail0, organization1)
	if err != nil {
		return err
	}

	fsInspectionsampledetail0.R.Organization = organization1

	organization1.R.FSInspectionsampledetails = append(organization1.R.FSInspectionsampledetails, fsInspectionsampledetail0)
...
func (fsInspectionsampledetailWhere[Q]) AliasedAs(alias string) fsInspectionsampledetailWhere[Q] {
	return buildFSInspectionsampledetailWhere[Q](buildFSInspectionsampledetailColumns(alias))
}
...
func (o *FSInspectionsampledetail) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("fsInspectionsampledetail cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.FSInspectionsampledetails = FSInspectionsampledetailSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("fsInspectionsampledetail has no relationship %q", name)
	}
}

type fsInspectionsampledetailPreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildFSInspectionsampledetailPreloader() fsInspectionsampledetailPreloader {
		...
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				...
				Sides: []psql.PreloadSide{
					{
						From:        FSInspectionsampledetails,
						To:          Organizations,
...
type fsInspectionsampledetailThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildFSInspectionsampledetailThenLoader[Q orm.Loadable]() fsInspectionsampledetailThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return fsInspectionsampledetailThenLoader[Q]{
...
func (o *FSInspectionsampledetail) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.FSInspectionsampledetails = FSInspectionsampledetailSlice{o}
...
type fsInspectionsampledetailJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j fsInspectionsampledetailJoins[Q]) aliasedAs(alias string) fsInspectionsampledetailJoins[Q] {
	return buildFSInspectionsampledetailJoins[Q](buildFSInspectionsampledetailColumns(alias), j.typ)
}

func buildFSInspectionsampledetailJoins[Q dialect.Joinable](cols fsInspectionsampledetailColumns, typ string) fsInspectionsampledetailJoins[Q] {
	return fsInspectionsampledetailJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

	...
	ForeignKeys: historyServicerequestForeignKeys{
		HistoryServicerequestHistoryServicerequestOrganizationIDFkey: foreignKey{
			constraint: constraint{
				Name:    "history_servicerequest.history_servicerequest_organization_id_fkey",
...
type historyServicerequestIndexes struct {
	HistoryServicerequestPkey index
}

func (i historyServicerequestIndexes) AsSlice() []index {
	return []index{
		i.HistoryServicerequestPkey,
	}
}

type historyServicerequestForeignKeys struct {
	HistoryServicerequestHistoryServicerequestOrganizationIDFkey foreignKey
}

func (f historyServicerequestForeignKeys) AsSlice() []foreignKey {
	return []foreignKey{
		f.HistoryServicerequestHistoryServicerequestOrganizationIDFkey,
	}
}

type historyServicerequestUniques struct{}

func (u historyServicerequestUniques) AsSlice() []constraint {
	return []constraint{}
}

type historyServicerequestChecks struct{}

func (c historyServicerequestChecks) AsSlice() []check {
	return []check{}
}

...
// Set the model columns to this value
func (m fieldseekerSpeciesabundanceMods) Processed(val null.Val[enums.FieldseekerSpeciesabundanceNotinuitFEnum]) FieldseekerSpeciesabundanceMod {
	return FieldseekerSpeciesabundanceModFunc(func(_ context.Context, o *FieldseekerSpeciesabundanceTemplate) {
		o.Processed = func() null.Val[enums.FieldseekerSpeciesabundanceNotinuitFEnum] { return val }
	})
}

// Set the Column from the function
func (m fieldseekerSpeciesabundanceMods) ProcessedFunc(f func() null.Val[enums.FieldseekerSpeciesabundanceNotinuitFEnum]) FieldseekerSpeciesabundanceMod {
	return FieldseekerSpeciesabundanceModFunc(func(_ context.Context, o *FieldseekerSpeciesabundanceTemplate) {
		o.Processed = f
	})
}
...
func (m fieldseekerSpeciesabundanceMods) RandomProcessed(f *faker.Faker) FieldseekerSpeciesabundanceMod {
	return FieldseekerSpeciesabundanceModFunc(func(_ context.Context, o *FieldseekerSpeciesabundanceTemplate) {
		o.Processed = func() null.Val[enums.FieldseekerSpeciesabundanceNotinuitFEnum] {
			if f == nil {
				f = &defaultFaker
			}

			val := random_enums_FieldseekerSpeciesabundanceNotinuitFEnum(f)
			return null.From(val)
		}
	})
}

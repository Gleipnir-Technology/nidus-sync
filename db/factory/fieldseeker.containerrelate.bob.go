...
// Set the model columns to this value
func (m fieldseekerContainerrelateMods) Containertype(val null.Val[enums.FieldseekerContainerrelateMosquitocontainertypeEnum]) FieldseekerContainerrelateMod {
	return FieldseekerContainerrelateModFunc(func(_ context.Context, o *FieldseekerContainerrelateTemplate) {
		o.Containertype = func() null.Val[enums.FieldseekerContainerrelateMosquitocontainertypeEnum] { return val }
	})
}

// Set the Column from the function
func (m fieldseekerContainerrelateMods) ContainertypeFunc(f func() null.Val[enums.FieldseekerContainerrelateMosquitocontainertypeEnum]) FieldseekerContainerrelateMod {
	return FieldseekerContainerrelateModFunc(func(_ context.Context, o *FieldseekerContainerrelateTemplate) {
		o.Containertype = f
	})
}
...
func (m fieldseekerContainerrelateMods) RandomContainertype(f *faker.Faker) FieldseekerContainerrelateMod {
	return FieldseekerContainerrelateModFunc(func(_ context.Context, o *FieldseekerContainerrelateTemplate) {
		o.Containertype = func() null.Val[enums.FieldseekerContainerrelateMosquitocontainertypeEnum] {
			if f == nil {
				f = &defaultFaker
			}

			val := random_enums_FieldseekerContainerrelateMosquitocontainertypeEnum(f)
			return null.From(val)
		}
	})
}

...
func FindFieldseekerPointlocation(ctx context.Context, exec bob.Executor, ObjectidPK int64, cols ...string) (*FieldseekerPointlocation, error) {
	if len(cols) == 0 {
...
func FieldseekerPointlocationExists(ctx context.Context, exec bob.Executor, ObjectidPK int64) (bool, error) {
	return FieldseekerPointlocations.Query(
		sm.Where(FieldseekerPointlocations.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
	).Exists(ctx, exec)
}
...
func (o *FieldseekerPointlocation) pkEQ() dialect.Expression {
	return psql.Quote("fieldseeker.pointlocation", "objectid").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o FieldseekerPointlocationSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("fieldseeker.pointlocation", "objectid").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {

...
// FSLinelocationSlice is an alias for a slice of pointers to FSLinelocation.
// This should almost always be used instead of []*FSLinelocation.
...
// fsLinelocationR is where relationships are stored.
type fsLinelocationR struct {
	Organization *Organization // fs_linelocation.fs_linelocation_organization_id_fkey
}

func buildFSLinelocationColumns(alias string) fsLinelocationColumns {
	return fsLinelocationColumns{
		ColumnsExpr: expr.NewColumnsExpr(
			"organization_id", "accessdesc", "acres", "active", "comments", "creationdate", "creator", "description", "externalid", "editdate", "editor", "globalid", "habitat", "hectares", "jurisdiction", "larvinspectinterval", "lastinspectactiontaken", "lastinspectactivity", "lastinspectavglarvae", "lastinspectavgpupae", "lastinspectbreeding", "lastinspectconditions", "lastinspectdate", "lastinspectfieldspecies", "lastinspectlstages", "lasttreatactivity", "lasttreatdate", "lasttreatproduct", "lasttreatqty", "lasttreatqtyunit", "length_ft", "length_meters", "locationnumber", "name", "nextactiondatescheduled", "objectid", "priority", "symbology", "shape__length", "usetype", "waterorigin", "width_ft", "width_meters", "zone", "zone2", "created_date", "created_user", "geometry_x", "geometry_y", "last_edited_date", "last_edited_user", "updated",
		).WithParent("fs_linelocation"),
		tableAlias:              alias,
...
func (c fsLinelocationColumns) Alias() string {
	return c.tableAlias
}

func (fsLinelocationColumns) AliasedAs(alias string) fsLinelocationColumns {
	return buildFSLinelocationColumns(alias)
}

// FSLinelocationSetter is used for insert/upsert/update operations
...
func (s *FSLinelocationSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
		...
		if s.Updated.IsValue() {
			vals[51] = psql.Arg(s.Updated.MustGet())
		} else {
...
func (s FSLinelocationSetter) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
...
// FindFSLinelocation retrieves a single record by primary key
// If cols is empty Find will return all columns.
func FindFSLinelocation(ctx context.Context, exec bob.Executor, ObjectidPK int32, cols ...string) (*FSLinelocation, error) {
	if len(cols) == 0 {
		return FSLinelocations.Query(
			sm.Where(FSLinelocations.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
		).One(ctx, exec)
	}

	return FSLinelocations.Query(
		sm.Where(FSLinelocations.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
		sm.Columns(FSLinelocations.Columns.Only(cols...)),
	).One(ctx, exec)
}
...
func (o *FSLinelocation) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	case bob.QueryTypeSelect:
		ctx, err = FSLinelocations.AfterSelectHooks.RunHooks(ctx, exec, FSLinelocationSlice{o})
	case bob.QueryTypeInsert:
		ctx, err = FSLinelocations.AfterInsertHooks.RunHooks(ctx, exec, FSLinelocationSlice{o})
	case bob.QueryTypeUpdate:
		ctx, err = FSLinelocations.AfterUpdateHooks.RunHooks(ctx, exec, FSLinelocationSlice{o})
	case bob.QueryTypeDelete:
		ctx, err = FSLinelocations.AfterDeleteHooks.RunHooks(ctx, exec, FSLinelocationSlice{o})
	}

	return err
}

// primaryKeyVals returns the primary key values of the FSLinelocation
func (o *FSLinelocation) primaryKeyVals() bob.Expression {
...
func (o *FSLinelocation) Update(ctx context.Context, exec bob.Executor, s *FSLinelocationSetter) error {
	v, err := FSLinelocations.Update(s.UpdateMod(), um.Where(o.pkEQ())).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *FSLinelocation) Delete(ctx context.Context, exec bob.Executor) error {
	_, err := FSLinelocations.Delete(dm.Where(o.pkEQ())).Exec(ctx, exec)
	return err
}
...
func (o *FSLinelocation) Reload(ctx context.Context, exec bob.Executor) error {
	o2, err := FSLinelocations.Query(
		sm.Where(FSLinelocations.Columns.Objectid.EQ(psql.Arg(o.Objectid))),
	).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o FSLinelocationSlice) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	switch queryType {
	case bob.QueryTypeSelect:
		ctx, err = FSLinelocations.AfterSelectHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeInsert:
		ctx, err = FSLinelocations.AfterInsertHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeUpdate:
		ctx, err = FSLinelocations.AfterUpdateHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeDelete:
		ctx, err = FSLinelocations.AfterDeleteHooks.RunHooks(ctx, exec, o)
	}

	return err
}

func (o FSLinelocationSlice) pkIN() dialect.Expression {
	if len(o) == 0 {
...
func (o FSLinelocationSlice) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
	return bob.ModFunc[*dialect.UpdateQuery](func(q *dialect.UpdateQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return FSLinelocations.BeforeUpdateHooks.RunHooks(ctx, exec, o)
		})
		...
		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			...
			case []*FSLinelocation:
				o.copyMatchingRows(retrieved...)
			case FSLinelocationSlice:
				o.copyMatchingRows(retrieved...)
			default:
				// If the retrieved value is not a FSLinelocation or a slice of FSLinelocation
				// then run the AfterUpdateHooks on the slice
				_, err = FSLinelocations.AfterUpdateHooks.RunHooks(ctx, exec, o)
			}
...
func (o FSLinelocationSlice) DeleteMod() bob.Mod[*dialect.DeleteQuery] {
	return bob.ModFunc[*dialect.DeleteQuery](func(q *dialect.DeleteQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return FSLinelocations.BeforeDeleteHooks.RunHooks(ctx, exec, o)
		})
		...
		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			...
			default:
				...
				_, err = FSLinelocations.AfterDeleteHooks.RunHooks(ctx, exec, o)
			}
...
func (o FSLinelocationSlice) UpdateAll(ctx context.Context, exec bob.Executor, vals FSLinelocationSetter) error {
	if len(o) == 0 {
		return nil
	}

	_, err := FSLinelocations.Update(vals.UpdateMod(), o.UpdateMod()).All(ctx, exec)
	return err
}
...
func (o FSLinelocationSlice) DeleteAll(ctx context.Context, exec bob.Executor) error {
	...
	_, err := FSLinelocations.Delete(o.DeleteMod()).Exec(ctx, exec)
	return err
}
...
func (o FSLinelocationSlice) ReloadAll(ctx context.Context, exec bob.Executor) error {
	...
	o2, err := FSLinelocations.Query(sm.Where(o.pkIN())).All(ctx, exec)
	if err != nil {
		return err
	}
...
func attachFSLinelocationOrganization0(ctx context.Context, exec bob.Executor, count int, fsLinelocation0 *FSLinelocation, organization1 *Organization) (*FSLinelocation, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("attachFSLinelocationOrganization0: %w", err)
	}

	return fsLinelocation0, nil
}
...
func (fsLinelocation0 *FSLinelocation) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachFSLinelocationOrganization0(ctx, exec, 1, fsLinelocation0, organization1)
	if err != nil {
		return err
	}

	fsLinelocation0.R.Organization = organization1

	organization1.R.FSLinelocations = append(organization1.R.FSLinelocations, fsLinelocation0)
...
func (fsLinelocationWhere[Q]) AliasedAs(alias string) fsLinelocationWhere[Q] {
	return buildFSLinelocationWhere[Q](buildFSLinelocationColumns(alias))
}
...
func (o *FSLinelocation) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("fsLinelocation cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.FSLinelocations = FSLinelocationSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("fsLinelocation has no relationship %q", name)
	}
}

type fsLinelocationPreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildFSLinelocationPreloader() fsLinelocationPreloader {
	return fsLinelocationPreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        FSLinelocations,
						To:          Organizations,
...
type fsLinelocationThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildFSLinelocationThenLoader[Q orm.Loadable]() fsLinelocationThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return fsLinelocationThenLoader[Q]{
...
func (o *FSLinelocation) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.FSLinelocations = FSLinelocationSlice{o}
...
type fsLinelocationJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j fsLinelocationJoins[Q]) aliasedAs(alias string) fsLinelocationJoins[Q] {
	return buildFSLinelocationJoins[Q](buildFSLinelocationColumns(alias), j.typ)
}

func buildFSLinelocationJoins[Q dialect.Joinable](cols fsLinelocationColumns, typ string) fsLinelocationJoins[Q] {
	return fsLinelocationJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

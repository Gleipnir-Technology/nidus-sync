...
// HistoryTreatmentSlice is an alias for a slice of pointers to HistoryTreatment.
// This should almost always be used instead of []*HistoryTreatment.
...
// historyTreatmentR is where relationships are stored.
type historyTreatmentR struct {
	Organization *Organization // history_treatment.history_treatment_organization_id_fkey
}
...
type historyTreatmentColumns struct {
	expr.ColumnsExpr
	tableAlias           string
...
func (historyTreatmentColumns) AliasedAs(alias string) historyTreatmentColumns {
	return buildHistoryTreatmentColumns(alias)
}

// HistoryTreatmentSetter is used for insert/upsert/update operations
...
func (s HistoryTreatmentSetter) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
...
// FindHistoryTreatment retrieves a single record by primary key
...
func FindHistoryTreatment(ctx context.Context, exec bob.Executor, ObjectidPK int32, VersionPK int32, cols ...string) (*HistoryTreatment, error) {
	if len(cols) == 0 {
		return HistoryTreatments.Query(
			sm.Where(HistoryTreatments.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
			sm.Where(HistoryTreatments.Columns.Version.EQ(psql.Arg(VersionPK))),
		).One(ctx, exec)
	}
	...
	return HistoryTreatments.Query(
		sm.Where(HistoryTreatments.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
		sm.Where(HistoryTreatments.Columns.Version.EQ(psql.Arg(VersionPK))),
		sm.Columns(HistoryTreatments.Columns.Only(cols...)),
	).One(ctx, exec)
}
...
func (o *HistoryTreatment) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	case bob.QueryTypeSelect:
		ctx, err = HistoryTreatments.AfterSelectHooks.RunHooks(ctx, exec, HistoryTreatmentSlice{o})
	case bob.QueryTypeInsert:
		ctx, err = HistoryTreatments.AfterInsertHooks.RunHooks(ctx, exec, HistoryTreatmentSlice{o})
	case bob.QueryTypeUpdate:
		ctx, err = HistoryTreatments.AfterUpdateHooks.RunHooks(ctx, exec, HistoryTreatmentSlice{o})
	case bob.QueryTypeDelete:
		ctx, err = HistoryTreatments.AfterDeleteHooks.RunHooks(ctx, exec, HistoryTreatmentSlice{o})
	}

	return err
}

// primaryKeyVals returns the primary key values of the HistoryTreatment
func (o *HistoryTreatment) primaryKeyVals() bob.Expression {
...
func (o *HistoryTreatment) Update(ctx context.Context, exec bob.Executor, s *HistoryTreatmentSetter) error {
	v, err := HistoryTreatments.Update(s.UpdateMod(), um.Where(o.pkEQ())).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *HistoryTreatment) Delete(ctx context.Context, exec bob.Executor) error {
	_, err := HistoryTreatments.Delete(dm.Where(o.pkEQ())).Exec(ctx, exec)
	return err
}
...
func (o *HistoryTreatment) Reload(ctx context.Context, exec bob.Executor) error {
	o2, err := HistoryTreatments.Query(
		sm.Where(HistoryTreatments.Columns.Objectid.EQ(psql.Arg(o.Objectid))),
		sm.Where(HistoryTreatments.Columns.Version.EQ(psql.Arg(o.Version))),
	).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o HistoryTreatmentSlice) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	switch queryType {
	case bob.QueryTypeSelect:
		ctx, err = HistoryTreatments.AfterSelectHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeInsert:
		ctx, err = HistoryTreatments.AfterInsertHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeUpdate:
		ctx, err = HistoryTreatments.AfterUpdateHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeDelete:
		ctx, err = HistoryTreatments.AfterDeleteHooks.RunHooks(ctx, exec, o)
	}

	return err
}

func (o HistoryTreatmentSlice) pkIN() dialect.Expression {
	if len(o) == 0 {
...
func (o HistoryTreatmentSlice) copyMatchingRows(from ...*HistoryTreatment) {
	for i, old := range o {
...
func (o HistoryTreatmentSlice) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
	return bob.ModFunc[*dialect.UpdateQuery](func(q *dialect.UpdateQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return HistoryTreatments.BeforeUpdateHooks.RunHooks(ctx, exec, o)
		})
		...
		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			...
			case []*HistoryTreatment:
				o.copyMatchingRows(retrieved...)
			case HistoryTreatmentSlice:
				o.copyMatchingRows(retrieved...)
			default:
				// If the retrieved value is not a HistoryTreatment or a slice of HistoryTreatment
				// then run the AfterUpdateHooks on the slice
				_, err = HistoryTreatments.AfterUpdateHooks.RunHooks(ctx, exec, o)
			}
...
func (o HistoryTreatmentSlice) DeleteMod() bob.Mod[*dialect.DeleteQuery] {
	return bob.ModFunc[*dialect.DeleteQuery](func(q *dialect.DeleteQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return HistoryTreatments.BeforeDeleteHooks.RunHooks(ctx, exec, o)
		})
		...
		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			...
			default:
				...
				_, err = HistoryTreatments.AfterDeleteHooks.RunHooks(ctx, exec, o)
			}
...
func (o HistoryTreatmentSlice) UpdateAll(ctx context.Context, exec bob.Executor, vals HistoryTreatmentSetter) error {
	if len(o) == 0 {
		return nil
	}

	_, err := HistoryTreatments.Update(vals.UpdateMod(), o.UpdateMod()).All(ctx, exec)
	return err
}
...
func (o HistoryTreatmentSlice) DeleteAll(ctx context.Context, exec bob.Executor) error {
	...
	_, err := HistoryTreatments.Delete(o.DeleteMod()).Exec(ctx, exec)
	return err
}
...
func (o HistoryTreatmentSlice) ReloadAll(ctx context.Context, exec bob.Executor) error {
	...
	o2, err := HistoryTreatments.Query(sm.Where(o.pkIN())).All(ctx, exec)
	if err != nil {
		return err
	}
...
func attachHistoryTreatmentOrganization0(ctx context.Context, exec bob.Executor, count int, historyTreatment0 *HistoryTreatment, organization1 *Organization) (*HistoryTreatment, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("attachHistoryTreatmentOrganization0: %w", err)
	}

	return historyTreatment0, nil
}
...
func (historyTreatment0 *HistoryTreatment) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachHistoryTreatmentOrganization0(ctx, exec, 1, historyTreatment0, organization1)
	if err != nil {
		return err
	}

	historyTreatment0.R.Organization = organization1

	organization1.R.HistoryTreatments = append(organization1.R.HistoryTreatments, historyTreatment0)
...
func (historyTreatmentWhere[Q]) AliasedAs(alias string) historyTreatmentWhere[Q] {
	return buildHistoryTreatmentWhere[Q](buildHistoryTreatmentColumns(alias))
}
...
func (o *HistoryTreatment) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("historyTreatment cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.HistoryTreatments = HistoryTreatmentSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("historyTreatment has no relationship %q", name)
	}
}

type historyTreatmentPreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildHistoryTreatmentPreloader() historyTreatmentPreloader {
	return historyTreatmentPreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        HistoryTreatments,
						To:          Organizations,
...
type historyTreatmentThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildHistoryTreatmentThenLoader[Q orm.Loadable]() historyTreatmentThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return historyTreatmentThenLoader[Q]{
...
func (o *HistoryTreatment) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.HistoryTreatments = HistoryTreatmentSlice{o}
...
type historyTreatmentJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j historyTreatmentJoins[Q]) aliasedAs(alias string) historyTreatmentJoins[Q] {
	return buildHistoryTreatmentJoins[Q](buildHistoryTreatmentColumns(alias), j.typ)
}

func buildHistoryTreatmentJoins[Q dialect.Joinable](cols historyTreatmentColumns, typ string) historyTreatmentJoins[Q] {
	return historyTreatmentJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

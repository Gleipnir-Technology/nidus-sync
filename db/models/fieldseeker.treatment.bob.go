...
func (s FieldseekerTreatmentSetter) Expressions(prefix ...string) []bob.Expression {
	exprs := make([]bob.Expression, 0, 54)
...
func FindFieldseekerTreatment(ctx context.Context, exec bob.Executor, ObjectidPK int64, cols ...string) (*FieldseekerTreatment, error) {
	if len(cols) == 0 {
...
func FieldseekerTreatmentExists(ctx context.Context, exec bob.Executor, ObjectidPK int64) (bool, error) {
	return FieldseekerTreatments.Query(
		sm.Where(FieldseekerTreatments.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
	).Exists(ctx, exec)
}
...
func (o *FieldseekerTreatment) pkEQ() dialect.Expression {
	return psql.Quote("fieldseeker.treatment", "objectid").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o FieldseekerTreatmentSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("fieldseeker.treatment", "objectid").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {

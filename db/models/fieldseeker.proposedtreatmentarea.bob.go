...
func FindFieldseekerProposedtreatmentarea(ctx context.Context, exec bob.Executor, ObjectidPK int64, cols ...string) (*FieldseekerProposedtreatmentarea, error) {
	if len(cols) == 0 {
...
func FieldseekerProposedtreatmentareaExists(ctx context.Context, exec bob.Executor, ObjectidPK int64) (bool, error) {
	return FieldseekerProposedtreatmentareas.Query(
		sm.Where(FieldseekerProposedtreatmentareas.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
	).Exists(ctx, exec)
}
...
func (o *FieldseekerProposedtreatmentarea) pkEQ() dialect.Expression {
	return psql.Quote("fieldseeker.proposedtreatmentarea", "objectid").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o FieldseekerProposedtreatmentareaSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("fieldseeker.proposedtreatmentarea", "objectid").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {

...
// fieldseekerPooldetailR is where relationships are stored.
type fieldseekerPooldetailR struct {
	Organization *Organization // fieldseeker.pooldetail.pooldetail_organization_id_fkey
}
...
func buildFieldseekerPooldetailColumns(alias string) fieldseekerPooldetailColumns {
	return fieldseekerPooldetailColumns{
		ColumnsExpr: expr.NewColumnsExpr(
			"objectid", "trapdata_id", "pool_id", "species", "females", "globalid", "created_user", "created_date", "last_edited_user", "last_edited_date", "creationdate", "creator", "editdate", "editor", "geometry", "geospatial", "version", "organization_id",
...
func attachFieldseekerPooldetailOrganization0(ctx context.Context, exec bob.Executor, count int, fieldseekerPooldetail0 *FieldseekerPooldetail, organization1 *Organization) (*FieldseekerPooldetail, error) {
	setter := &FieldseekerPooldetailSetter{
		OrganizationID: omit.From(organization1.ID),
	}

	err := fieldseekerPooldetail0.Update(ctx, exec, setter)
	if err != nil {
		return nil, fmt.Errorf("attachFieldseekerPooldetailOrganization0: %w", err)
	}

	return fieldseekerPooldetail0, nil
}
...
func (fieldseekerPooldetail0 *FieldseekerPooldetail) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachFieldseekerPooldetailOrganization0(ctx, exec, 1, fieldseekerPooldetail0, organization1)
	if err != nil {
		return err
	}

	fieldseekerPooldetail0.R.Organization = organization1

	organization1.R.Pooldetails = append(organization1.R.Pooldetails, fieldseekerPooldetail0)
...
func (o *FieldseekerPooldetail) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("fieldseekerPooldetail cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.Pooldetails = FieldseekerPooldetailSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("fieldseekerPooldetail has no relationship %q", name)
	}
}

type fieldseekerPooldetailPreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildFieldseekerPooldetailPreloader() fieldseekerPooldetailPreloader {
	return fieldseekerPooldetailPreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        FieldseekerPooldetails,
						To:          Organizations,
...
type fieldseekerPooldetailThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildFieldseekerPooldetailThenLoader[Q orm.Loadable]() fieldseekerPooldetailThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return fieldseekerPooldetailThenLoader[Q]{
...
func (o *FieldseekerPooldetail) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.Pooldetails = FieldseekerPooldetailSlice{o}
...
type fieldseekerPooldetailJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j fieldseekerPooldetailJoins[Q]) aliasedAs(alias string) fieldseekerPooldetailJoins[Q] {
	return buildFieldseekerPooldetailJoins[Q](buildFieldseekerPooldetailColumns(alias), j.typ)
}

func buildFieldseekerPooldetailJoins[Q dialect.Joinable](cols fieldseekerPooldetailColumns, typ string) fieldseekerPooldetailJoins[Q] {
	return fieldseekerPooldetailJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

...
// fieldseekerContainerrelateR is where relationships are stored.
type fieldseekerContainerrelateR struct {
	Organization *Organization // fieldseeker.containerrelate.containerrelate_organization_id_fkey
}
...
func buildFieldseekerContainerrelateColumns(alias string) fieldseekerContainerrelateColumns {
	return fieldseekerContainerrelateColumns{
		ColumnsExpr: expr.NewColumnsExpr(
			"objectid", "globalid", "created_user", "created_date", "last_edited_user", "last_edited_date", "inspsampleid", "mosquitoinspid", "treatmentid", "containertype", "creationdate", "creator", "editdate", "editor", "geometry", "geospatial", "version", "organization_id",
...
func attachFieldseekerContainerrelateOrganization0(ctx context.Context, exec bob.Executor, count int, fieldseekerContainerrelate0 *FieldseekerContainerrelate, organization1 *Organization) (*FieldseekerContainerrelate, error) {
	setter := &FieldseekerContainerrelateSetter{
		OrganizationID: omit.From(organization1.ID),
	}

	err := fieldseekerContainerrelate0.Update(ctx, exec, setter)
	if err != nil {
		return nil, fmt.Errorf("attachFieldseekerContainerrelateOrganization0: %w", err)
	}

	return fieldseekerContainerrelate0, nil
}
...
func (fieldseekerContainerrelate0 *FieldseekerContainerrelate) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachFieldseekerContainerrelateOrganization0(ctx, exec, 1, fieldseekerContainerrelate0, organization1)
	if err != nil {
		return err
	}

	fieldseekerContainerrelate0.R.Organization = organization1

	organization1.R.Containerrelates = append(organization1.R.Containerrelates, fieldseekerContainerrelate0)
...
func (o *FieldseekerContainerrelate) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("fieldseekerContainerrelate cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.Containerrelates = FieldseekerContainerrelateSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("fieldseekerContainerrelate has no relationship %q", name)
	}
}

type fieldseekerContainerrelatePreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildFieldseekerContainerrelatePreloader() fieldseekerContainerrelatePreloader {
	return fieldseekerContainerrelatePreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        FieldseekerContainerrelates,
						To:          Organizations,
...
type fieldseekerContainerrelateThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildFieldseekerContainerrelateThenLoader[Q orm.Loadable]() fieldseekerContainerrelateThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return fieldseekerContainerrelateThenLoader[Q]{
...
func (o *FieldseekerContainerrelate) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.Containerrelates = FieldseekerContainerrelateSlice{o}
...
type fieldseekerContainerrelateJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j fieldseekerContainerrelateJoins[Q]) aliasedAs(alias string) fieldseekerContainerrelateJoins[Q] {
	return buildFieldseekerContainerrelateJoins[Q](buildFieldseekerContainerrelateColumns(alias), j.typ)
}

func buildFieldseekerContainerrelateJoins[Q dialect.Joinable](cols fieldseekerContainerrelateColumns, typ string) fieldseekerContainerrelateJoins[Q] {
	return fieldseekerContainerrelateJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

...
// fieldseekerInspectionsampleR is where relationships are stored.
type fieldseekerInspectionsampleR struct {
	Organization *Organization // fieldseeker.inspectionsample.inspectionsample_organization_id_fkey
}
...
func buildFieldseekerInspectionsampleColumns(alias string) fieldseekerInspectionsampleColumns {
	return fieldseekerInspectionsampleColumns{
		ColumnsExpr: expr.NewColumnsExpr(
			"objectid", "insp_id", "sampleid", "processed", "idbytech", "globalid", "created_user", "created_date", "last_edited_user", "last_edited_date", "creationdate", "creator", "editdate", "editor", "geometry", "geospatial", "version", "organization_id",
...
func attachFieldseekerInspectionsampleOrganization0(ctx context.Context, exec bob.Executor, count int, fieldseekerInspectionsample0 *FieldseekerInspectionsample, organization1 *Organization) (*FieldseekerInspectionsample, error) {
	setter := &FieldseekerInspectionsampleSetter{
		OrganizationID: omit.From(organization1.ID),
	}

	err := fieldseekerInspectionsample0.Update(ctx, exec, setter)
	if err != nil {
		return nil, fmt.Errorf("attachFieldseekerInspectionsampleOrganization0: %w", err)
	}

	return fieldseekerInspectionsample0, nil
}
...
func (fieldseekerInspectionsample0 *FieldseekerInspectionsample) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachFieldseekerInspectionsampleOrganization0(ctx, exec, 1, fieldseekerInspectionsample0, organization1)
	if err != nil {
		return err
	}

	fieldseekerInspectionsample0.R.Organization = organization1

	organization1.R.Inspectionsamples = append(organization1.R.Inspectionsamples, fieldseekerInspectionsample0)
...
func (o *FieldseekerInspectionsample) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("fieldseekerInspectionsample cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.Inspectionsamples = FieldseekerInspectionsampleSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("fieldseekerInspectionsample has no relationship %q", name)
	}
}

type fieldseekerInspectionsamplePreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildFieldseekerInspectionsamplePreloader() fieldseekerInspectionsamplePreloader {
	return fieldseekerInspectionsamplePreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        FieldseekerInspectionsamples,
						To:          Organizations,
...
type fieldseekerInspectionsampleThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildFieldseekerInspectionsampleThenLoader[Q orm.Loadable]() fieldseekerInspectionsampleThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return fieldseekerInspectionsampleThenLoader[Q]{
...
func (o *FieldseekerInspectionsample) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.Inspectionsamples = FieldseekerInspectionsampleSlice{o}
...
type fieldseekerInspectionsampleJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j fieldseekerInspectionsampleJoins[Q]) aliasedAs(alias string) fieldseekerInspectionsampleJoins[Q] {
	return buildFieldseekerInspectionsampleJoins[Q](buildFieldseekerInspectionsampleColumns(alias), j.typ)
}

func buildFieldseekerInspectionsampleJoins[Q dialect.Joinable](cols fieldseekerInspectionsampleColumns, typ string) fieldseekerInspectionsampleJoins[Q] {
	return fieldseekerInspectionsampleJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

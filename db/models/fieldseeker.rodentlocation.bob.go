...
type FieldseekerRodentlocation struct {
	...
	Habitat      null.Val[enums.FieldseekerRodentlocationRodentlocationhabitatEnum]   `db:"habitat" `
	Priority     null.Val[enums.FieldseekerRodentlocationLocationpriority1Enum]       `db:"priority" `
	Usetype      null.Val[enums.FieldseekerRodentlocationLocationusetype1Enum]        `db:"usetype" `
	Active       null.Val[enums.FieldseekerRodentlocationNotinuitF1Enum]              `db:"active" `
	Description  null.Val[string]                                                     `db:"description" `
	Accessdesc   null.Val[string]                                                     `db:"accessdesc" `
	Comments     null.Val[string]                                                     `db:"comments" `
	Symbology    null.Val[enums.FieldseekerRodentlocationRodentlocationSymbologyEnum] `db:"symbology" `
	// External ID
	...
	// Last Inspection Rodent Evidence
...
type FieldseekerRodentlocationSetter struct {
	...
	Habitat                   omitnull.Val[enums.FieldseekerRodentlocationRodentlocationhabitatEnum]   `db:"habitat" `
	Priority                  omitnull.Val[enums.FieldseekerRodentlocationLocationpriority1Enum]       `db:"priority" `
	Usetype                   omitnull.Val[enums.FieldseekerRodentlocationLocationusetype1Enum]        `db:"usetype" `
	Active                    omitnull.Val[enums.FieldseekerRodentlocationNotinuitF1Enum]              `db:"active" `
	Description               omitnull.Val[string]                                                     `db:"description" `
	Accessdesc                omitnull.Val[string]                                                     `db:"accessdesc" `
	Comments                  omitnull.Val[string]                                                     `db:"comments" `
	Symbology                 omitnull.Val[enums.FieldseekerRodentlocationRodentlocationSymbologyEnum] `db:"symbology" `
...
func (s *FieldseekerRodentlocationSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
		...
		if !s.Locationname.IsUnset() {
			vals[2] = psql.Arg(s.Locationname.MustGetNull())
		} else {
		...
		if !s.Zone2.IsUnset() {
			vals[4] = psql.Arg(s.Zone2.MustGetNull())
		} else {
			vals[4] = psql.Raw("DEFAULT")
		}

		if !s.Habitat.IsUnset() {
			vals[5] = psql.Arg(s.Habitat.MustGetNull())
		} else {
			vals[5] = psql.Raw("DEFAULT")
		}

		if !s.Priority.IsUnset() {
			vals[6] = psql.Arg(s.Priority.MustGetNull())
		} else {
			vals[6] = psql.Raw("DEFAULT")
		}

		if !s.Usetype.IsUnset() {
			vals[7] = psql.Arg(s.Usetype.MustGetNull())
		} else {
			vals[7] = psql.Raw("DEFAULT")
		}

		if !s.Active.IsUnset() {
			vals[8] = psql.Arg(s.Active.MustGetNull())
		} else {
			vals[8] = psql.Raw("DEFAULT")
		}

		if !s.Description.IsUnset() {
			vals[9] = psql.Arg(s.Description.MustGetNull())
		} else {
			vals[9] = psql.Raw("DEFAULT")
		}

		if !s.Accessdesc.IsUnset() {
			vals[10] = psql.Arg(s.Accessdesc.MustGetNull())
		} else {
			vals[10] = psql.Raw("DEFAULT")
		}

		if !s.Comments.IsUnset() {
			vals[11] = psql.Arg(s.Comments.MustGetNull())
		} else {
		...
		if !s.Externalid.IsUnset() {
			vals[13] = psql.Arg(s.Externalid.MustGetNull())
		} else {
		...
		if !s.Lastinspectdate.IsUnset() {
			vals[16] = psql.Arg(s.Lastinspectdate.MustGetNull())
		} else {
			vals[16] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectspecies.IsUnset() {
			vals[17] = psql.Arg(s.Lastinspectspecies.MustGetNull())
		} else {
			vals[17] = psql.Raw("DEFAULT")
		}

		if !s.Lastinspectaction.IsUnset() {
			vals[18] = psql.Arg(s.Lastinspectaction.MustGetNull())
		} else {
		...
		if !s.Lastinspectrodentevidence.IsUnset() {
			vals[20] = psql.Arg(s.Lastinspectrodentevidence.MustGetNull())
		} else {
			vals[20] = psql.Raw("DEFAULT")
		}

		if !s.Globalid.IsUnset() {
			vals[21] = psql.Arg(s.Globalid.MustGetNull())
		} else {
		...
		if !s.LastEditedUser.IsUnset() {
			vals[24] = psql.Arg(s.LastEditedUser.MustGetNull())
		} else {
		...
		if !s.Jurisdiction.IsUnset() {
			vals[30] = psql.Arg(s.Jurisdiction.MustGetNull())
		} else {
...
func FindFieldseekerRodentlocation(ctx context.Context, exec bob.Executor, ObjectidPK int64, cols ...string) (*FieldseekerRodentlocation, error) {
	if len(cols) == 0 {
...
func FieldseekerRodentlocationExists(ctx context.Context, exec bob.Executor, ObjectidPK int64) (bool, error) {
	return FieldseekerRodentlocations.Query(
		sm.Where(FieldseekerRodentlocations.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
	).Exists(ctx, exec)
}
...
func (o *FieldseekerRodentlocation) pkEQ() dialect.Expression {
	return psql.Quote("fieldseeker.rodentlocation", "objectid").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o FieldseekerRodentlocationSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("fieldseeker.rodentlocation", "objectid").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
type fieldseekerRodentlocationWhere[Q psql.Filterable] struct {
	...
	Habitat                   psql.WhereNullMod[Q, enums.FieldseekerRodentlocationRodentlocationhabitatEnum]
	Priority                  psql.WhereNullMod[Q, enums.FieldseekerRodentlocationLocationpriority1Enum]
	Usetype                   psql.WhereNullMod[Q, enums.FieldseekerRodentlocationLocationusetype1Enum]
	Active                    psql.WhereNullMod[Q, enums.FieldseekerRodentlocationNotinuitF1Enum]
	Description               psql.WhereNullMod[Q, string]
	Accessdesc                psql.WhereNullMod[Q, string]
	Comments                  psql.WhereNullMod[Q, string]
	Symbology                 psql.WhereNullMod[Q, enums.FieldseekerRodentlocationRodentlocationSymbologyEnum]
...
func buildFieldseekerRodentlocationWhere[Q psql.Filterable](cols fieldseekerRodentlocationColumns) fieldseekerRodentlocationWhere[Q] {
	return fieldseekerRodentlocationWhere[Q]{
		...
		Habitat:                   psql.WhereNull[Q, enums.FieldseekerRodentlocationRodentlocationhabitatEnum](cols.Habitat),
		Priority:                  psql.WhereNull[Q, enums.FieldseekerRodentlocationLocationpriority1Enum](cols.Priority),
		Usetype:                   psql.WhereNull[Q, enums.FieldseekerRodentlocationLocationusetype1Enum](cols.Usetype),
		Active:                    psql.WhereNull[Q, enums.FieldseekerRodentlocationNotinuitF1Enum](cols.Active),
		Description:               psql.WhereNull[Q, string](cols.Description),
		Accessdesc:                psql.WhereNull[Q, string](cols.Accessdesc),
		Comments:                  psql.WhereNull[Q, string](cols.Comments),
		Symbology:                 psql.WhereNull[Q, enums.FieldseekerRodentlocationRodentlocationSymbologyEnum](cols.Symbology),

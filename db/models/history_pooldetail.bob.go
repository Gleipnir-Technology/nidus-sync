...
// historyPooldetailR is where relationships are stored.
type historyPooldetailR struct {
	Organization *Organization // history_pooldetail.history_pooldetail_organization_id_fkey
}
...
func attachHistoryPooldetailOrganization0(ctx context.Context, exec bob.Executor, count int, historyPooldetail0 *HistoryPooldetail, organization1 *Organization) (*HistoryPooldetail, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("attachHistoryPooldetailOrganization0: %w", err)
	}

	return historyPooldetail0, nil
}
...
func (historyPooldetail0 *HistoryPooldetail) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachHistoryPooldetailOrganization0(ctx, exec, 1, historyPooldetail0, organization1)
	if err != nil {
		return err
	}

	historyPooldetail0.R.Organization = organization1

	organization1.R.HistoryPooldetails = append(organization1.R.HistoryPooldetails, historyPooldetail0)
...
func (o *HistoryPooldetail) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("historyPooldetail cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.HistoryPooldetails = HistoryPooldetailSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("historyPooldetail has no relationship %q", name)
	}
}

type historyPooldetailPreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildHistoryPooldetailPreloader() historyPooldetailPreloader {
	return historyPooldetailPreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        HistoryPooldetails,
						To:          Organizations,
...
type historyPooldetailThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildHistoryPooldetailThenLoader[Q orm.Loadable]() historyPooldetailThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return historyPooldetailThenLoader[Q]{
...
func (o *HistoryPooldetail) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.HistoryPooldetails = HistoryPooldetailSlice{o}
...
type historyPooldetailJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j historyPooldetailJoins[Q]) aliasedAs(alias string) historyPooldetailJoins[Q] {
	return buildHistoryPooldetailJoins[Q](buildHistoryPooldetailColumns(alias), j.typ)
}

func buildHistoryPooldetailJoins[Q dialect.Joinable](cols historyPooldetailColumns, typ string) historyPooldetailJoins[Q] {
	return historyPooldetailJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

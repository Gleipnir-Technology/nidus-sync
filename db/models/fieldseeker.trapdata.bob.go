...
func FindFieldseekerTrapdatum(ctx context.Context, exec bob.Executor, ObjectidPK int64, cols ...string) (*FieldseekerTrapdatum, error) {
	if len(cols) == 0 {
...
func FieldseekerTrapdatumExists(ctx context.Context, exec bob.Executor, ObjectidPK int64) (bool, error) {
	return FieldseekerTrapdata.Query(
		sm.Where(FieldseekerTrapdata.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
	).Exists(ctx, exec)
}
...
func (o *FieldseekerTrapdatum) pkEQ() dialect.Expression {
	return psql.Quote("fieldseeker.trapdata", "objectid").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o FieldseekerTrapdatumSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("fieldseeker.trapdata", "objectid").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {

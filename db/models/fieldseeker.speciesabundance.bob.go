...
// fieldseekerSpeciesabundanceR is where relationships are stored.
type fieldseekerSpeciesabundanceR struct {
	Organization *Organization // fieldseeker.speciesabundance.speciesabundance_organization_id_fkey
}
...
func buildFieldseekerSpeciesabundanceColumns(alias string) fieldseekerSpeciesabundanceColumns {
	return fieldseekerSpeciesabundanceColumns{
		ColumnsExpr: expr.NewColumnsExpr(
			"objectid", "trapdata_id", "species", "males", "unknown", "bloodedfem", "gravidfem", "larvae", "poolstogen", "processed", "globalid", "created_user", "created_date", "last_edited_user", "last_edited_date", "pupae", "eggs", "females", "total", "creationdate", "creator", "editdate", "editor", "yearweek", "globalzscore", "r7score", "r8score", "h3r7", "h3r8", "geometry", "geospatial", "version", "organization_id",
...
func (s *FieldseekerSpeciesabundanceSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
		...
		if s.Geometry.IsValue() {
			vals[29] = psql.Arg(s.Geometry.MustGet())
		} else {
			vals[29] = psql.Raw("DEFAULT")
		}

		if !s.Geospatial.IsUnset() {
			vals[30] = psql.Arg(s.Geospatial.MustGetNull())
		} else {
		...
		if s.OrganizationID.IsValue() {
			vals[32] = psql.Arg(s.OrganizationID.MustGet())
		} else {
...
func attachFieldseekerSpeciesabundanceOrganization0(ctx context.Context, exec bob.Executor, count int, fieldseekerSpeciesabundance0 *FieldseekerSpeciesabundance, organization1 *Organization) (*FieldseekerSpeciesabundance, error) {
	setter := &FieldseekerSpeciesabundanceSetter{
		OrganizationID: omit.From(organization1.ID),
	}

	err := fieldseekerSpeciesabundance0.Update(ctx, exec, setter)
	if err != nil {
		return nil, fmt.Errorf("attachFieldseekerSpeciesabundanceOrganization0: %w", err)
	}

	return fieldseekerSpeciesabundance0, nil
}
...
func (fieldseekerSpeciesabundance0 *FieldseekerSpeciesabundance) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachFieldseekerSpeciesabundanceOrganization0(ctx, exec, 1, fieldseekerSpeciesabundance0, organization1)
	if err != nil {
		return err
	}

	fieldseekerSpeciesabundance0.R.Organization = organization1

	organization1.R.Speciesabundances = append(organization1.R.Speciesabundances, fieldseekerSpeciesabundance0)
...
func (o *FieldseekerSpeciesabundance) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("fieldseekerSpeciesabundance cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.Speciesabundances = FieldseekerSpeciesabundanceSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("fieldseekerSpeciesabundance has no relationship %q", name)
	}
}

type fieldseekerSpeciesabundancePreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildFieldseekerSpeciesabundancePreloader() fieldseekerSpeciesabundancePreloader {
	return fieldseekerSpeciesabundancePreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        FieldseekerSpeciesabundances,
						To:          Organizations,
...
type fieldseekerSpeciesabundanceThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildFieldseekerSpeciesabundanceThenLoader[Q orm.Loadable]() fieldseekerSpeciesabundanceThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return fieldseekerSpeciesabundanceThenLoader[Q]{
...
func (o *FieldseekerSpeciesabundance) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.Speciesabundances = FieldseekerSpeciesabundanceSlice{o}

...
// fsTrapdatumR is where relationships are stored.
type fsTrapdatumR struct {
	Organization *Organization // fs_trapdata.fs_trapdata_organization_id_fkey
}
...
func attachFSTrapdatumOrganization0(ctx context.Context, exec bob.Executor, count int, fsTrapdatum0 *FSTrapdatum, organization1 *Organization) (*FSTrapdatum, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("attachFSTrapdatumOrganization0: %w", err)
	}

	return fsTrapdatum0, nil
}
...
func (fsTrapdatum0 *FSTrapdatum) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachFSTrapdatumOrganization0(ctx, exec, 1, fsTrapdatum0, organization1)
	if err != nil {
		return err
	}

	fsTrapdatum0.R.Organization = organization1

	organization1.R.FSTrapdata = append(organization1.R.FSTrapdata, fsTrapdatum0)
...
func (o *FSTrapdatum) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("fsTrapdatum cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.FSTrapdata = FSTrapdatumSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("fsTrapdatum has no relationship %q", name)
	}
}

type fsTrapdatumPreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildFSTrapdatumPreloader() fsTrapdatumPreloader {
	return fsTrapdatumPreloader{
...
type fsTrapdatumThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildFSTrapdatumThenLoader[Q orm.Loadable]() fsTrapdatumThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return fsTrapdatumThenLoader[Q]{
...
func (o *FSTrapdatum) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.FSTrapdata = FSTrapdatumSlice{o}
...
type fsTrapdatumJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j fsTrapdatumJoins[Q]) aliasedAs(alias string) fsTrapdatumJoins[Q] {
	return buildFSTrapdatumJoins[Q](buildFSTrapdatumColumns(alias), j.typ)
}

func buildFSTrapdatumJoins[Q dialect.Joinable](cols fsTrapdatumColumns, typ string) fsTrapdatumJoins[Q] {
	return fsTrapdatumJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

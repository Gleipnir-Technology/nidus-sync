...
// HistorySamplecollectionSlice is an alias for a slice of pointers to HistorySamplecollection.
// This should almost always be used instead of []*HistorySamplecollection.
...
// historySamplecollectionR is where relationships are stored.
type historySamplecollectionR struct {
	Organization *Organization // history_samplecollection.history_samplecollection_organization_id_fkey
}
...
func (c historySamplecollectionColumns) Alias() string {
	return c.tableAlias
}

func (historySamplecollectionColumns) AliasedAs(alias string) historySamplecollectionColumns {
	return buildHistorySamplecollectionColumns(alias)
}

// HistorySamplecollectionSetter is used for insert/upsert/update operations
...
func (s *HistorySamplecollectionSetter) Apply(q *dialect.InsertQuery) {
...
func (s HistorySamplecollectionSetter) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
...
// FindHistorySamplecollection retrieves a single record by primary key
...
func FindHistorySamplecollection(ctx context.Context, exec bob.Executor, ObjectidPK int32, VersionPK int32, cols ...string) (*HistorySamplecollection, error) {
	if len(cols) == 0 {
		return HistorySamplecollections.Query(
			sm.Where(HistorySamplecollections.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
			sm.Where(HistorySamplecollections.Columns.Version.EQ(psql.Arg(VersionPK))),
		).One(ctx, exec)
	}
	...
	return HistorySamplecollections.Query(
		sm.Where(HistorySamplecollections.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
		sm.Where(HistorySamplecollections.Columns.Version.EQ(psql.Arg(VersionPK))),
		sm.Columns(HistorySamplecollections.Columns.Only(cols...)),
	).One(ctx, exec)
}
...
func (o *HistorySamplecollection) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	case bob.QueryTypeSelect:
		ctx, err = HistorySamplecollections.AfterSelectHooks.RunHooks(ctx, exec, HistorySamplecollectionSlice{o})
	case bob.QueryTypeInsert:
		ctx, err = HistorySamplecollections.AfterInsertHooks.RunHooks(ctx, exec, HistorySamplecollectionSlice{o})
	case bob.QueryTypeUpdate:
		ctx, err = HistorySamplecollections.AfterUpdateHooks.RunHooks(ctx, exec, HistorySamplecollectionSlice{o})
	case bob.QueryTypeDelete:
		ctx, err = HistorySamplecollections.AfterDeleteHooks.RunHooks(ctx, exec, HistorySamplecollectionSlice{o})
	}

	return err
}

// primaryKeyVals returns the primary key values of the HistorySamplecollection
func (o *HistorySamplecollection) primaryKeyVals() bob.Expression {
...
func (o *HistorySamplecollection) Update(ctx context.Context, exec bob.Executor, s *HistorySamplecollectionSetter) error {
	v, err := HistorySamplecollections.Update(s.UpdateMod(), um.Where(o.pkEQ())).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *HistorySamplecollection) Delete(ctx context.Context, exec bob.Executor) error {
	_, err := HistorySamplecollections.Delete(dm.Where(o.pkEQ())).Exec(ctx, exec)
	return err
}

// Reload refreshes the HistorySamplecollection using the executor
func (o *HistorySamplecollection) Reload(ctx context.Context, exec bob.Executor) error {
	o2, err := HistorySamplecollections.Query(
		sm.Where(HistorySamplecollections.Columns.Objectid.EQ(psql.Arg(o.Objectid))),
		sm.Where(HistorySamplecollections.Columns.Version.EQ(psql.Arg(o.Version))),
	).One(ctx, exec)
	if err != nil {
		return err
	}
...
func (o HistorySamplecollectionSlice) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	switch queryType {
	case bob.QueryTypeSelect:
		ctx, err = HistorySamplecollections.AfterSelectHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeInsert:
		ctx, err = HistorySamplecollections.AfterInsertHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeUpdate:
		ctx, err = HistorySamplecollections.AfterUpdateHooks.RunHooks(ctx, exec, o)
	case bob.QueryTypeDelete:
		ctx, err = HistorySamplecollections.AfterDeleteHooks.RunHooks(ctx, exec, o)
	}

	return err
}

func (o HistorySamplecollectionSlice) pkIN() dialect.Expression {
	if len(o) == 0 {
...
func (o HistorySamplecollectionSlice) copyMatchingRows(from ...*HistorySamplecollection) {
	for i, old := range o {
...
func (o HistorySamplecollectionSlice) UpdateMod() bob.Mod[*dialect.UpdateQuery] {
	return bob.ModFunc[*dialect.UpdateQuery](func(q *dialect.UpdateQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return HistorySamplecollections.BeforeUpdateHooks.RunHooks(ctx, exec, o)
		})

		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			var err error
			switch retrieved := retrieved.(type) {
			case *HistorySamplecollection:
				o.copyMatchingRows(retrieved)
			case []*HistorySamplecollection:
				o.copyMatchingRows(retrieved...)
			case HistorySamplecollectionSlice:
				o.copyMatchingRows(retrieved...)
			default:
				// If the retrieved value is not a HistorySamplecollection or a slice of HistorySamplecollection
				// then run the AfterUpdateHooks on the slice
				_, err = HistorySamplecollections.AfterUpdateHooks.RunHooks(ctx, exec, o)
			}
...
func (o HistorySamplecollectionSlice) DeleteMod() bob.Mod[*dialect.DeleteQuery] {
	return bob.ModFunc[*dialect.DeleteQuery](func(q *dialect.DeleteQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return HistorySamplecollections.BeforeDeleteHooks.RunHooks(ctx, exec, o)
		})
		...
		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			...
			default:
				...
				_, err = HistorySamplecollections.AfterDeleteHooks.RunHooks(ctx, exec, o)
			}
...
func (o HistorySamplecollectionSlice) UpdateAll(ctx context.Context, exec bob.Executor, vals HistorySamplecollectionSetter) error {
	if len(o) == 0 {
		return nil
	}

	_, err := HistorySamplecollections.Update(vals.UpdateMod(), o.UpdateMod()).All(ctx, exec)
	return err
}

func (o HistorySamplecollectionSlice) DeleteAll(ctx context.Context, exec bob.Executor) error {
	if len(o) == 0 {
		return nil
	}

	_, err := HistorySamplecollections.Delete(o.DeleteMod()).Exec(ctx, exec)
	return err
}

func (o HistorySamplecollectionSlice) ReloadAll(ctx context.Context, exec bob.Executor) error {
	if len(o) == 0 {
		return nil
	}

	o2, err := HistorySamplecollections.Query(sm.Where(o.pkIN())).All(ctx, exec)
	if err != nil {
		return err
	}
...
func (o *HistorySamplecollection) Organization(mods ...bob.Mod[*dialect.SelectQuery]) OrganizationsQuery {
...
func attachHistorySamplecollectionOrganization0(ctx context.Context, exec bob.Executor, count int, historySamplecollection0 *HistorySamplecollection, organization1 *Organization) (*HistorySamplecollection, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("attachHistorySamplecollectionOrganization0: %w", err)
	}

	return historySamplecollection0, nil
}
...
func (historySamplecollection0 *HistorySamplecollection) InsertOrganization(ctx context.Context, exec bob.Executor, related *OrganizationSetter) error {
	...
	_, err = attachHistorySamplecollectionOrganization0(ctx, exec, 1, historySamplecollection0, organization1)
	if err != nil {
		return err
	}

	historySamplecollection0.R.Organization = organization1

	organization1.R.HistorySamplecollections = append(organization1.R.HistorySamplecollections, historySamplecollection0)
...
func (historySamplecollectionWhere[Q]) AliasedAs(alias string) historySamplecollectionWhere[Q] {
	return buildHistorySamplecollectionWhere[Q](buildHistorySamplecollectionColumns(alias))
}
...
func (o *HistorySamplecollection) Preload(name string, retrieved any) error {
	...
	case "Organization":
		...
		if !ok {
			return fmt.Errorf("historySamplecollection cannot load %T as %q", retrieved, name)
		}

		o.R.Organization = rel

		if rel != nil {
			rel.R.HistorySamplecollections = HistorySamplecollectionSlice{o}
		}
		return nil
	default:
		return fmt.Errorf("historySamplecollection has no relationship %q", name)
	}
}

type historySamplecollectionPreloader struct {
	Organization func(...psql.PreloadOption) psql.Preloader
}

func buildHistorySamplecollectionPreloader() historySamplecollectionPreloader {
	return historySamplecollectionPreloader{
		Organization: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*Organization, OrganizationSlice](psql.PreloadRel{
				Name: "Organization",
				Sides: []psql.PreloadSide{
					{
						From:        HistorySamplecollections,
						To:          Organizations,
...
type historySamplecollectionThenLoader[Q orm.Loadable] struct {
	Organization func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}

func buildHistorySamplecollectionThenLoader[Q orm.Loadable]() historySamplecollectionThenLoader[Q] {
	type OrganizationLoadInterface interface {
		LoadOrganization(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}

	return historySamplecollectionThenLoader[Q]{
...
func (o *HistorySamplecollection) LoadOrganization(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	...
	related.R.HistorySamplecollections = HistorySamplecollectionSlice{o}
...
type historySamplecollectionJoins[Q dialect.Joinable] struct {
	typ          string
	Organization modAs[Q, organizationColumns]
}

func (j historySamplecollectionJoins[Q]) aliasedAs(alias string) historySamplecollectionJoins[Q] {
	return buildHistorySamplecollectionJoins[Q](buildHistorySamplecollectionColumns(alias), j.typ)
}

func buildHistorySamplecollectionJoins[Q dialect.Joinable](cols historySamplecollectionColumns, typ string) historySamplecollectionJoins[Q] {
	return historySamplecollectionJoins[Q]{
		typ: typ,
		Organization: modAs[Q, organizationColumns]{

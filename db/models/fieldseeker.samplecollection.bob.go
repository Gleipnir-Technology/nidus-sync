...
type FieldseekerSamplecollection struct {
	...
	// Conditions
	Sitecond null.Val[enums.FieldseekerSamplecollectionMosquitositeconditionEnum] `db:"sitecond" `
	// Sample ID
	...
	// Processed
	Processed null.Val[enums.FieldseekerSamplecollectionNotinuitFEnum] `db:"processed" `
	// Sample Type
	Sampletype null.Val[enums.FieldseekerSamplecollectionMosquitosampletypeEnum] `db:"sampletype" `
	// Sample Condition
	Samplecond null.Val[enums.FieldseekerSamplecollectionMosquitosampleconditionEnum] `db:"samplecond" `
	// Species
	Species null.Val[enums.FieldseekerSamplecollectionMosquitosamplespeciesEnum] `db:"species" `
	// Sex
	Sex null.Val[enums.FieldseekerSamplecollectionNotinuisexEnum] `db:"sex" `
	// Average Temperature
	Avetemp null.Val[float64] `db:"avetemp" `
	// Wind Speed
	Windspeed null.Val[float64] `db:"windspeed" `
	// Wind Direction
	Winddir null.Val[enums.FieldseekerSamplecollectionNotinuiwinddirectionEnum] `db:"winddir" `
	// Rain Gauge
	Raingauge null.Val[float64] `db:"raingauge" `
	// Activity
	Activity null.Val[enums.FieldseekerSamplecollectionMosquitoactivityEnum] `db:"activity" `
	// Test Method
	Testmethod null.Val[enums.FieldseekerSamplecollectionMosquitotestmethodEnum] `db:"testmethod" `
	// Disease Tested
	Diseasetested null.Val[enums.FieldseekerSamplecollectionMosquitodiseaseEnum] `db:"diseasetested" `
	// Disease Positive
	Diseasepos null.Val[enums.FieldseekerSamplecollectionMosquitodiseaseEnum] `db:"diseasepos" `
	// Reviewed
	Reviewed null.Val[enums.FieldseekerSamplecollectionNotinuitFEnum] `db:"reviewed" `
	// Reviewed By
	...
	// Lab
	Lab null.Val[enums.FieldseekerSamplecollectionMosquitolabnameEnum] `db:"lab" `
	// Field Tech
...
type FieldseekerSamplecollectionSetter struct {
	...
	Sitecond       omitnull.Val[enums.FieldseekerSamplecollectionMosquitositeconditionEnum]   `db:"sitecond" `
	...
	Processed      omitnull.Val[enums.FieldseekerSamplecollectionNotinuitFEnum]               `db:"processed" `
	Sampletype     omitnull.Val[enums.FieldseekerSamplecollectionMosquitosampletypeEnum]      `db:"sampletype" `
	Samplecond     omitnull.Val[enums.FieldseekerSamplecollectionMosquitosampleconditionEnum] `db:"samplecond" `
	Species        omitnull.Val[enums.FieldseekerSamplecollectionMosquitosamplespeciesEnum]   `db:"species" `
	Sex            omitnull.Val[enums.FieldseekerSamplecollectionNotinuisexEnum]              `db:"sex" `
	Avetemp        omitnull.Val[float64]                                                      `db:"avetemp" `
	Windspeed      omitnull.Val[float64]                                                      `db:"windspeed" `
	Winddir        omitnull.Val[enums.FieldseekerSamplecollectionNotinuiwinddirectionEnum]    `db:"winddir" `
	Raingauge      omitnull.Val[float64]                                                      `db:"raingauge" `
	Activity       omitnull.Val[enums.FieldseekerSamplecollectionMosquitoactivityEnum]        `db:"activity" `
	Testmethod     omitnull.Val[enums.FieldseekerSamplecollectionMosquitotestmethodEnum]      `db:"testmethod" `
	Diseasetested  omitnull.Val[enums.FieldseekerSamplecollectionMosquitodiseaseEnum]         `db:"diseasetested" `
	Diseasepos     omitnull.Val[enums.FieldseekerSamplecollectionMosquitodiseaseEnum]         `db:"diseasepos" `
	Reviewed       omitnull.Val[enums.FieldseekerSamplecollectionNotinuitFEnum]               `db:"reviewed" `
	...
	Lab            omitnull.Val[enums.FieldseekerSamplecollectionMosquitolabnameEnum]         `db:"lab" `
...
func FindFieldseekerSamplecollection(ctx context.Context, exec bob.Executor, ObjectidPK int64, cols ...string) (*FieldseekerSamplecollection, error) {
	if len(cols) == 0 {
...
func FieldseekerSamplecollectionExists(ctx context.Context, exec bob.Executor, ObjectidPK int64) (bool, error) {
	return FieldseekerSamplecollections.Query(
		sm.Where(FieldseekerSamplecollections.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
	).Exists(ctx, exec)
}
...
func (o *FieldseekerSamplecollection) pkEQ() dialect.Expression {
	return psql.Quote("fieldseeker.samplecollection", "objectid").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o FieldseekerSamplecollectionSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("fieldseeker.samplecollection", "objectid").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
type fieldseekerSamplecollectionWhere[Q psql.Filterable] struct {
	...
	Sitecond       psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitositeconditionEnum]
	...
	Processed      psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionNotinuitFEnum]
	Sampletype     psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitosampletypeEnum]
	Samplecond     psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitosampleconditionEnum]
	Species        psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitosamplespeciesEnum]
	Sex            psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionNotinuisexEnum]
	Avetemp        psql.WhereNullMod[Q, float64]
	Windspeed      psql.WhereNullMod[Q, float64]
	Winddir        psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionNotinuiwinddirectionEnum]
	Raingauge      psql.WhereNullMod[Q, float64]
	Activity       psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitoactivityEnum]
	Testmethod     psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitotestmethodEnum]
	Diseasetested  psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitodiseaseEnum]
	Diseasepos     psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitodiseaseEnum]
	Reviewed       psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionNotinuitFEnum]
	...
	Lab            psql.WhereNullMod[Q, enums.FieldseekerSamplecollectionMosquitolabnameEnum]
...
func buildFieldseekerSamplecollectionWhere[Q psql.Filterable](cols fieldseekerSamplecollectionColumns) fieldseekerSamplecollectionWhere[Q] {
	return fieldseekerSamplecollectionWhere[Q]{
		...
		Sitecond:       psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitositeconditionEnum](cols.Sitecond),
		...
		Processed:      psql.WhereNull[Q, enums.FieldseekerSamplecollectionNotinuitFEnum](cols.Processed),
		Sampletype:     psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitosampletypeEnum](cols.Sampletype),
		Samplecond:     psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitosampleconditionEnum](cols.Samplecond),
		Species:        psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitosamplespeciesEnum](cols.Species),
		Sex:            psql.WhereNull[Q, enums.FieldseekerSamplecollectionNotinuisexEnum](cols.Sex),
		Avetemp:        psql.WhereNull[Q, float64](cols.Avetemp),
		Windspeed:      psql.WhereNull[Q, float64](cols.Windspeed),
		Winddir:        psql.WhereNull[Q, enums.FieldseekerSamplecollectionNotinuiwinddirectionEnum](cols.Winddir),
		Raingauge:      psql.WhereNull[Q, float64](cols.Raingauge),
		Activity:       psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitoactivityEnum](cols.Activity),
		Testmethod:     psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitotestmethodEnum](cols.Testmethod),
		Diseasetested:  psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitodiseaseEnum](cols.Diseasetested),
		Diseasepos:     psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitodiseaseEnum](cols.Diseasepos),
		Reviewed:       psql.WhereNull[Q, enums.FieldseekerSamplecollectionNotinuitFEnum](cols.Reviewed),
		...
		Lab:            psql.WhereNull[Q, enums.FieldseekerSamplecollectionMosquitolabnameEnum](cols.Lab),

...
func FindFieldseekerPool(ctx context.Context, exec bob.Executor, ObjectidPK int64, cols ...string) (*FieldseekerPool, error) {
	if len(cols) == 0 {
...
func FieldseekerPoolExists(ctx context.Context, exec bob.Executor, ObjectidPK int64) (bool, error) {
	return FieldseekerPools.Query(
		sm.Where(FieldseekerPools.Columns.Objectid.EQ(psql.Arg(ObjectidPK))),
	).Exists(ctx, exec)
}
...
func (o *FieldseekerPool) pkEQ() dialect.Expression {
	return psql.Quote("fieldseeker.pool", "objectid").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o FieldseekerPoolSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("fieldseeker.pool", "objectid").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {

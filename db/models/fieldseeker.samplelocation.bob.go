...
func buildFieldseekerSamplelocationColumns(alias string) fieldseekerSamplelocationColumns {
	return fieldseekerSamplelocationColumns{
		ColumnsExpr: expr.NewColumnsExpr(
			"objectid", "name", "zone", "habitat", "priority", "usetype", "active", "description", "accessdesc", "comments", "externalid", "nextactiondatescheduled", "zone2", "locationnumber", "globalid", "created_user", "created_date", "last_edited_user", "last_edited_date", "gatewaysync", "creationdate", "creator", "editdate", "editor", "version",
...
func (s *FieldseekerSamplelocationSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
		...
		if s.Version.IsValue() {
			vals[24] = psql.Arg(s.Version.MustGet())
		} else {
